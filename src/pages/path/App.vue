<template>
    <div id="guideWrap">
        ...
        <div id="guideHeader">
            ...
            <div class="fr">
                <div class="total">Total : {{pathData.length}}</div>
            </div>
        </div>
        <!-- //Header -->
        ...
        <div class="pathList">
            <table class="pathTbl">
                ...
                <tbody>
                    <tr v-for="item in pathData" :key="item.name">
                        <th class='dep1' scope='row'>{{item.name}}</th>
                        <td class='url'><a :href="item.url" target='_blank' title='새창'>{{item.url}}</a></td>
                        <td class='txt'></td>
					</tr>
                </tbody>
            </table>
